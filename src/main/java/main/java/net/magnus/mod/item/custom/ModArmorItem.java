...
import main.java.net.magnus.mod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.ENDERITE_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.REGENERATION, 1000, 1, false, false),
                                    (new StatusEffectInstance(StatusEffects.SPEED, 1000, 0, false, false)),
                                    new StatusEffectInstance(StatusEffects.HEALTH_BOOST, 1000, 3, false, false)))
                    .build();
