...
public class EnderiteScytheItem extends ToolItem {
    public EnderiteScytheItem(ToolMaterial toolMaterial, Item.Settings settings) {
        super(toolMaterial, settings.component(DataComponentTypes.TOOL, createToolComponent()));
    }

    private static ToolComponent createToolComponent() {
        return new ToolComponent(
                List.of(ToolComponent.Rule.ofAlwaysDropping(List.of(Blocks.COBWEB), 20.0F), ToolComponent.Rule.of(BlockTags.SWORD_EFFICIENT, 2.0F)), 1.0F, 2
        );
    }
