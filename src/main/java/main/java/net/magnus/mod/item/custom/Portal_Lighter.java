...
public class Portal_Lighter extends Item {
    public Portal_Lighter(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        if(Screen.hasShiftDown()) {} {
            tooltip.add(Text.translatable("tooltip.mod.portal_lighter.shift_down.1"));
        } {
            tooltip.add(Text.translatable("tooltip.mod.portal_lighter.shift_down.2"));
        }

        if(stack.get(ModDataComponentTypes.COORDINATES) != null) {
            tooltip.add(Text.literal("Last Block Or Portal Litten At " + stack.get(ModDataComponentTypes.COORDINATES)));
        }
